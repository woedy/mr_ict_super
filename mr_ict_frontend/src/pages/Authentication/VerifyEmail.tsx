...
const VerifyEmail = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await api.post('accounts/verify-student-email/', {
        email,
        email_token: code,
      });
      ...
      if (data?.errors) {
        ...
        setInputError((errorMessages as string[]).join('\n'));
      } else {
  ...
  const handleResend = async (e) => {
    ...
    try {
      await api.post('accounts/resend-student-email-verification/', { email });
