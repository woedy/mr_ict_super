...
const AllMyCourses: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const response = await api.get('courses/get-all-courses/', { params: { page, search } });
  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4">
        <h4 className="text-xl font-semibold text-black dark:text-white mb-4 mt-9">My Courses</h4>
