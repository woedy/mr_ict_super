    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marital_status', models.BooleanField(blank=True, default=False, null=True)),
                ('phone', models.CharField(blank=True, max_length=255, null=True)),
                ('country', models.CharField(blank=True, max_length=255, null=True)),
                ('language', models.CharField(blank=True, default='English', max_length=255, null=True)),
                ('about_me', models.TextField(blank=True, null=True)),
                ('user_type', models.CharField(blank=True, choices=[('Student', 'Student'), ('Teacher', 'Teacher'), ('Admin', 'Admin')], max_length=100, null=True)),
