...
import AddStudentModel from './modals/AddDishCategoryModal';
...
const ArchivedStudents = () => {
  ...
  const handleArchive = async (itemId) => {
    ...
    try {
      const response = await fetch(
        `${baseUrl}api/students/unarchive-student/`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  return (
    <div>
      <Breadcrumb pageName="Archived Students" />
            ...
            ? students.map((student) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                        <div className="h-12 w-12 overflow-hidden rounded-md mr-2">
                          <img
                            src={`${baseUrlMedia}${student.school_logo}`}
                            alt="school logo"
                            className="h-full w-full object-cover"
                          />
                        </div>
                  ...
                  <div className="col-span-1 hidden items-center sm:flex">
                    <p className="text-sm text-black dark:text-white">
                      <div className="flex items-center space-x-3.5">
                        ...
                        <button
                          className="hover:text-primary"
                          onClick={() => openDeleteModal(student.student_id)} // Pass the ID of the item to be deleted
                        >
                          <svg
                            className="fill-current"
                            width="18"
